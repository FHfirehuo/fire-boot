...
var required = require('requires-port')
  ...
  , relativere = /^\/(?!\/)/
  , protocolre = /^([a-z0-9.+-]+:)?(\/\/)?(.*)$/i; // actual protocol is first
													// match
...
var instructions = [
 ...
 /**
	 ...
	 * @property {Boolean} slashes Indicates whether the protocol is followed by
	 *           double slash ("//")
 ...
 * 
 * @param {String}
 *            prop Property we need to adjust.
 * @param {Mixed}
